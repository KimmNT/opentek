    ...
    <div className="method__container">
      ...
      <div className="method__content">
        ...
        <div className="method__transaction">
          <div className="gtc__content">
            ...
            <div className="gtc__item">
              ...
              <div className="gtc__coin">
                <div
                  className={
                    balance - productInfo.productPrice >= 0
                      ? "gtc__coin_number"
                      : "gtc__coin_number error"
                  }
                >
                  {handelFormat(balance - productInfo.productPrice)}
                  <span className="currency">GT</span>
                </div>
              </div>
            </div>
          ...
          {balance - productInfo.productPrice >= 0 ? (
            <div onClick={() => setCreateOrder(true)} className="gtc__enough">
              continue
            </div>
          ) : (
            <div className="gtc__notenough">
              ...
              <div
                onClick={() =>
                  navigateToPage("/payment-gtc/payment-gtc-with-cash", {
                    productInfo: productInfo,
                    balance: balance,
                    agencyId: agencyId,
                    machineId: machineId,
